...
def test_create_superuser_without_staff_flag(user_manager):
    ...
    with pytest.raises(ValueError) as excinfo:
        user_manager.create_superuser(email='superuser@example.com', password=12345,is_staff=False)
...
def test_create_superuser_without_superuser_flag(user_manager):
    ...
    with pytest.raises(ValueError) as excinfo:
        user_manager.create_superuser(email='superuser@example.com', password=12345,is_superuser=False)
